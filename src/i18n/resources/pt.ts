		...
		definitions: {
			task: {
				...
				query: {
					...
					description: "Seleciona tarefas com uma consulta de fluxo de trabalho compacta.",
					input: {
						query: {
							label: "Consulta",
							description: "Objeto codificado por campos de tarefa. Os valores podem ser literais ou filtros { operator, value }.",
						},
					},
					output: {
						tasks: {
