		...
		definitions: {
			task: {
				...
				query: {
					...
					description: "Выбирает задачи с помощью компактного запроса рабочего процесса.",
					input: {
						query: {
							label: "Запрос",
							description: "Объект с ключом по полям задачи. Значения могут быть литералами или фильтрами { operator, value }.",
						},
					},
					output: {
						tasks: {
