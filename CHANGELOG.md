...
- Initial unreleased development of TaskNotes Workflows.
- Moved the workflow enabled control into the editor header and clarified that disabled workflows cannot run manually or from triggers.
- Added an i18n runtime, language setting, translation resources, and verification scripts for plugin interface copy.
